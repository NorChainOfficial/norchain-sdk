  ...
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS device_keys CASCADE;`);
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS messaging_profiles CASCADE;`);
    ...
    await queryRunner.query(`DROP TABLE IF EXISTS period_closures CASCADE;`);
    await queryRunner.query(`DROP TABLE IF EXISTS journal_lines CASCADE;`);
