...
export class OrdersController {
  ...
  @ApiQuery({ name: 'user', description: 'User wallet address', required: true })
  @ApiResponse({ status: 200, description: 'Limit orders retrieved successfully' })
  ...
  @ApiResponse({ status: 201, description: 'Stop-loss order created successfully' })
  ...
  @ApiQuery({ name: 'user', description: 'User wallet address', required: true })
  @ApiResponse({ status: 200, description: 'Stop-loss orders retrieved successfully' })
  ...
  @ApiResponse({ status: 201, description: 'DCA schedule created successfully' })
  ...
  @ApiQuery({ name: 'user', description: 'User wallet address', required: true })
  @ApiResponse({ status: 200, description: 'DCA schedules retrieved successfully' })
