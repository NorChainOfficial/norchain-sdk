...
export class TransactionController {
  ...
  @ApiResponse({ status: 200, description: 'Transaction receipt status retrieved successfully' })
  ...
  @Public()
  @Get('getstatus')
  @ApiOperation({ summary: 'Get transaction status (pending/confirmed/failed)' })
