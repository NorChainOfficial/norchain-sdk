  ...
  return (
    <section id="developer-tools" className="py-20 bg-gradient-to-b from-black via-gray-950 to-black scroll-mt-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-[600px] h-[600px] bg-gradient-to-br from-emerald-600/10 via-green-600/15 to-emerald-500/10 rounded-full blur-3xl" />
        <div className="absolute bottom-20 right-20 w-[500px] h-[500px] bg-gradient-to-tl from-green-600/10 via-emerald-600/15 to-green-500/10 rounded-full blur-3xl" />
        <div className="absolute inset-0 bg-[linear-gradient(rgba(5,150,105,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(5,150,105,0.03)_1px,transparent_1px)] bg-[size:100px_100px]" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-24">
          <div className="relative inline-block mb-8">
            ...
            <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-24 h-1.5 bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-500 rounded-full" />
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            {[
              { value: "99.9%", label: "API Uptime", color: "from-emerald-500 to-green-600", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
              { value: "<85ms", label: "Response Time", color: "from-emerald-500 to-green-600", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
              { value: "3s", label: "Block Time", color: "from-emerald-500 to-green-600", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
              { value: "127+", label: "Active Developers", color: "from-emerald-500 to-green-600", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" }
            ].map((stat, index) => (
              ...
              <div className="bg-black/60 backdrop-blur-lg rounded-2xl p-8 border border-gray-800/50 overflow-x-auto">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-gray-800/80 hover:bg-gray-700/80 text-emerald-400 hover:text-emerald-300 text-sm rounded-xl transition-all duration-300 font-medium shadow-lg"
                ...
                <pre className="text-emerald-100 text-sm leading-relaxed overflow-x-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <div className="relative">
              <div className="absolute -inset-1 bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-500 rounded-2xl blur opacity-75"></div>
              <a
                href="https://docs.norchain.org/getting-started"
                target="_blank"
                rel="noopener noreferrer"
                className="relative group inline-flex items-center gap-3 px-12 py-5 bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-500 text-white font-bold text-lg rounded-2xl hover:shadow-2xl hover:shadow-emerald-500/30 transition-all duration-500 hover:scale-105"
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-500 via-green-500 to-emerald-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl" />
              </a>
            </div>
          ...
          <div className="absolute top-32 left-32 w-3 h-3 bg-emerald-500 rounded-full animate-pulse opacity-60" />
          <div className="absolute top-52 right-40 w-2 h-2 bg-green-500 rounded-full animate-pulse opacity-50" style={{animationDelay: '1s'}} />
          <div className="absolute bottom-32 left-40 w-4 h-4 bg-emerald-600 rounded-lg rotate-45 animate-pulse opacity-40" style={{animationDelay: '2s'}} />
          <div className="absolute bottom-52 right-32 w-2 h-2 bg-green-600 rounded-full animate-pulse opacity-60" style={{animationDelay: '3s'}} />
        </div>
      </div>
    </section>
  );
