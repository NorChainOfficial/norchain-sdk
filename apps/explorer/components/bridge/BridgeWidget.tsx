...
import { createPublicClient, createWalletClient, custom, parseEther, formatEther, parseUnits, formatUnits, type Address } from 'viem';
...
export default function BridgeWidget(): JSX.Element {
  ...
  const handleBridge = useCallback(async () => {
    ...
    try {
      ...
      // Execute bridge
      setStatus('bridging');
      setStatusMessage(`Bridging ${amount} ${tokenInfo.symbol} to NorChain...`);
      ...
      setStatusMessage(
        `Success! ${received} W${tokenInfo.symbol} will arrive on NorChain in ~30 seconds. Fee: ${fee} ${tokenInfo.symbol} (0.2%)`
      );
    ...
    <div className="max-w-xl mx-auto">
      <div className="bg-white rounded-2xl shadow-2xl p-8">
        ...
        <div className="mb-6">
          ...
          />
          <p className="text-xs text-gray-500 mt-1">
            The address that will receive W{tokenInfo.symbol} on NorChain
          </p>
        </div>
        ...
        <button
          ...
          aria-label="Bridge tokens to NorChain"
        >
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-xl border border-gray-200">
          ...
          <div className="text-xs text-gray-600 space-y-1">
            ...
            <p><strong>To:</strong> NorChain (Chain ID: 65001)</p>
