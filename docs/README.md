# NorChain Ecosystem Documentation

Complete documentation for the NorChain ecosystem monorepo.
...
- [Database Architecture](./architecture/SHARED_DATABASE.md) - Database design

### [Development](./development/)
- [Development Infrastructure](./development/DEVELOPMENT_INFRASTRUCTURE.md) - Dev setup and tools
- [Environment Configuration](./development/ENV_TEMPLATE.md) - Environment variables
- [Monorepo Setup](./development/MONOREPO_SETUP.md) - Monorepo configuration
- [API Integration](./development/API_RENAME_COMPLETE.md) - API integration guide
...
- [Environment Setup](./development/ENV_TEMPLATE.md)
- [API Integration](./development/API_RENAME_COMPLETE.md)

### For DevOps
- [Docker Setup](./deployment/DOCKER_SETUP.md)
- [Port Configuration](./deployment/PORTS_CONFIGURATION.md)
- [Deployment Guide](./deployment/DOCKER_COMPLETE.md)
