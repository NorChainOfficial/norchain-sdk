        ...
        ZStack {
            ...
            VStack {
                ...
                Button(action: {
                    ...
                    .foregroundColor(.white)
                    .cornerRadius(16)
                    .shadow(color: Color(hex: "7C3AED").opacity(0.5), radius: 20, y: 10)
                }
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Text(fee)
                ...
                .foregroundColor(isSelected ? Color(hex: "10B981") : .white.opacity(0.5))
        }
        .frame(maxWidth: .infinity)
        .padding(.vertical, 12)
        .background(
            RoundedRectangle(cornerRadius: 12)
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: 12)
                        .stroke(
                            isSelected ? Color(hex: "8B5CF6").opacity(0.5) : Color.white.opacity(0.15),
